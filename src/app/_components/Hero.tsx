...
export default function Hero() {
  return (
    <div className='flex flex-col items-center bg-gradient-to-r from-white to-gray-100'>
        ...
        <div className='sm:text-6xl text-4xl px-10 sm:leading-snug text-center text-gray-800 w-10/12 break-words '>Transform Dreams into Global Ventures with StackSurge</div>
        <div className='sm:text-xl mt-8 mb-11 text-lg text-center px-5 sm:px-10'>Where Big Ideas Meet Big Investor</div>
